...
These templates provide a ready to execute GHUnit Test bundle with (or without) OCMock and NLTHTTPStubServer included in your unit tests.
...
* NLTHTTPStubServer v0.1.1   https://github.com/yaakaito/NLTHTTPStubServer
